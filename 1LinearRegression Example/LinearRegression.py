...
x=x.values.reshape(-1,1) #iki boyutlu numpy array'e dönüştürülüyor ilk boyuttaki eleman sayısına 100'de yazılabilir. -1 yazılırsa kendi hesaplar
y=y.values.reshape(-1,1) #iki boyuta dönüştürülüyor
